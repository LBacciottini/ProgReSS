...
import progress.net.messages as messages
...
class Module(ns.nodes.Node):
    ...
    behavior, which is implemented in a class that inherits from :class:`~progress.net.p_module.ModuleBehavior`.
    ...
    qhal : :class:`~progress.net.qhal.QHAL` or None, optional
...
class ModuleBehavior(ns.protocols.ServiceProtocol, ABC):
    ...
    Parameters
    ----------
    node : :class:`~progress.net.p_module.Module`
    ...
    def handle_message(self, request):
        ...
        Parameters
        ----------
        request : :class:`~progress.net.p_module.ModuleBehavior.req_handle_message`
    ...
    def handle_response(self, request):
        ...
        Parameters
        ----------
        request : :class:`~progress.net.p_module.ModuleBehavior.req_handle_response`
    ...
    def handle_new_token(self, request):
        ...
        Parameters
        ----------
        request : :class:`~progress.net.p_module.ModuleBehavior.req_handle_new_token`
    ...
    def free_token(self, token):
        ...
        Parameters
        ----------
        token : :class:`~progress.net.kernel.p_token.Token`
            The token to free.
        """
...
class ProcessingModuleBehavior(ModuleBehavior, ABC):
    ...
    def dejmps_tokens(self, token_a, token_b, role):
        ...
        Parameters
        ----------
        token_a : :class:`~progress.net.kernel.p_token.Token`
            The token to distill.
        token_b : :class:`~progress.net.kernel.p_token.Token`
    ...
    def apply_qcircuit(self, tokens, qcircuit):
        ...
        Parameters
        ----------
        tokens : list of :class:`~progress.net.kernel.p_token.Token`
