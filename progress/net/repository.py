...
from progress.net.p_module import ProcessingModuleBehavior, SchedulingModuleBehavior
...
class EntanglementSwappingModuleBehavior(ProcessingModuleBehavior):
    ...
    def __init__(self, dest_devices, dest_module_ids, name, node, qnic=None):
        ...
        dest_module_ids : tuple
            ...
            They are supposed to be instances of :class:`~progress.net.repository.WaitForSwappingModuleBehavior`.
        name : str
            The name of the module
        node : :class:`~progress.progress.p_module.Module`
            The module that this behavior is attached to
        qnic : int or None, optional
            See :class:`~progress.net.p_module.ModuleBehavior`.
        """
