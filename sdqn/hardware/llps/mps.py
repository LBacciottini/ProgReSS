"""This module implements the behavior of a node having Midpoint source protocol activated on one of its links."""

from netsquid.components import Message, SourceStatus
from netsquid.protocols.nodeprotocols import NodeProtocol
import sdqn.sdqn_logging as qilog
...
class MPSProtocol(LinkProtocol):
    ...
    def start(self):
        """Start this protocols on a specified link of this node.
        """
