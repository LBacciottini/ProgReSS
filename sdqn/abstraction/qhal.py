...
class QHAL(ns.nodes.Node):
    ...
    qhardware : :class:`~sdqn.hardware.qhardware.QHardware`
        The QHardware placed in the same SDQN device.
    """
...
class TokenOperationsService(ns.protocols.ServiceProtocol):
    ...
    Parameters:
        token (:class:`~sdqn.sockets.Token`): The token to free.
    """
    ...
    Parameters:
        ...
        token1 (:class:`~sdqn.sockets.Token`): The first token to swap.
        token2 (:class:`~sdqn.sockets.Token`): The second token to swap.
    """
    ...
    Parameters:
        id (int): The id of the requesting module.
        token1 (:class:`~sdqn.sockets.Token`): The first token to distill.
        token2 (:class:`~sdqn.sockets.Token`): The second token to distill.
    ...
    Parameters:
        id (int): The id of the requesting module.
        token (:class:`~sdqn.sockets.Token`): The token to correct.
    """
    ...
    Parameters:
        id (int): The id of the requesting module.
        tokens (list of :class:`~sdqn.sockets.Token`): The list of tokens in input to the quantum operation.
